...
$router->add('GET', 'api/notifications/count', 'NotificationsController@count', 'notifications.api.count');

// Действия с уведомлениями
$router->add('POST', 'notifications/{id}/read', 'NotificationsController@markAsRead', 'notifications.read');
$router->add('POST', 'notifications/mark-all-read', 'NotificationsController@markAllRead', 'notifications.markAllRead');