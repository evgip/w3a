...
(4, 1, 'Admin', 'admin', '127.0.0.1', 'admin.tag_updated', 'Администратор изменил параметры тега #libarea', 'general', NULL, '2026-06-19 05:47:20'),
(5, 1, 'Admin', 'admin', '127.0.0.1', 'admin.tag_updated', 'Администратор изменил параметры тега #php', 'general', NULL, '2026-06-19 05:47:29'),
(6, 1, 'Admin', 'admin', '127.0.0.1', 'admin.tag_updated', 'Администратор изменил параметры тега #security', 'general', NULL, '2026-06-19 05:47:39'),
(7, 1, 'Admin', 'admin', '127.0.0.1', 'admin.tag_updated', 'Администратор изменил параметры тега #show', 'general', NULL, '2026-06-19 05:47:51'),
(8, 1, 'Admin', 'admin', '127.0.0.1', 'admin.tag_updated', 'Администратор изменил параметры тега #video', 'general', NULL, '2026-06-19 05:47:59');
...
(1, 'Языки программирования', 'languages', 'PHP, Python, JavaScript и другие', 10, '2026-06-16 13:10:39', '2026-06-16 13:10:39', NULL),
(2, 'Практики', 'practices', 'Безопасность, архитектура, методологии', 20, '2026-06-16 13:10:39', '2026-06-16 13:10:39', NULL),
(3, 'Формат', 'format', 'Видео, демонстрации проектов, подкасты', 30, '2026-06-16 13:10:39', '2026-06-16 13:10:39', NULL),
(4, 'Разное', 'other', 'Общие темы и обсуждения', 99, '2026-06-16 13:10:39', '2026-06-16 13:10:39', NULL);
...
CREATE TABLE `comments` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `confidence_score` decimal(10,8) DEFAULT '0.00000000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 1, 1, NULL, 'Отличная архитектура у фреймворка!', 1, 0, 0, '2026-06-08 01:20:16', '2026-06-21 20:48:02', NULL, 0.37844750),
(2, 1, 1, 1, 'Согласен, один SQL-запрос на дерево — это быстро.', 1, 0, 0, '2026-06-08 01:20:16', '2026-06-21 20:48:02', NULL, 0.37844750),
(3, 1, 1, 2, 'И рекурсия на анонимных функциях PHP выглядит лаконично.', 1, 0, 0, '2026-06-08 01:20:16', '2026-06-21 20:48:02', NULL, 0.37844750),
(4, 1, 1, NULL, 'А когда мы добавим форму отправки нового комментария?', 1, 0, 0, '2026-06-08 01:20:16', '2026-06-21 20:48:02', NULL, 0.37844750),
(5, 2, 1, NULL, 'Добавим первые комментарий 333', 1, 0, 0, '2026-06-08 01:51:00', '2026-06-21 20:48:02', NULL, 0.37844750),
(6, 2, 1, 5, 'Добавим ответ Админу', 2, 0, 0, '2026-06-08 01:51:12', '2026-06-21 20:48:02', NULL, 0.54909237);
...
(729, '127.0.0.1', 'global.get', '2026-06-22 14:53:13'),
(730, '127.0.0.1', 'global.get', '2026-06-22 14:53:13'),
(731, '127.0.0.1', 'global.get', '2026-06-22 14:53:23'),
(732, '127.0.0.1', 'global.get', '2026-06-22 14:53:23'),
(733, '127.0.0.1', 'global.get', '2026-06-22 14:53:34'),
(734, '127.0.0.1', 'global.get', '2026-06-22 14:53:34'),
(735, '127.0.0.1', 'global.get', '2026-06-22 14:53:45'),
(736, '127.0.0.1', 'global.get', '2026-06-22 14:53:45'),
(737, '127.0.0.1', 'global.get', '2026-06-22 14:53:55'),
(738, '127.0.0.1', 'global.get', '2026-06-22 14:53:55'),
(739, '127.0.0.1', 'global.get', '2026-06-22 14:54:02'),
(740, '127.0.0.1', 'global.get', '2026-06-22 14:54:04'),
(741, '127.0.0.1', 'global.get', '2026-06-22 14:54:05'),
(742, '127.0.0.1', 'global.get', '2026-06-22 14:54:05'),
(744, '127.0.0.1', 'global.get', '2026-06-22 14:54:07'),
(745, '127.0.0.1', 'global.get', '2026-06-22 14:54:07'),
(746, '127.0.0.1', 'global.get', '2026-06-22 14:54:16'),
(743, '127.0.0.1', 'global.post', '2026-06-22 14:54:07');
...
(1, 1, 2, 6, '2026-06-16 19:32:51'),
(2, 1, 1, 4, '2026-06-19 05:48:40');
...
(1, 1, 'Первый пост, написал статью про этот движок.', 'https://libarea.ru/articles/2222/reshil-napisat-lobsters-na-php', 'libarea.ru', 'Редирект будет на LibArea, а если нажать на домен, то сортировка публикаций тут по этому домену.', 15, 14376.8, 0, 0, 4, '2026-06-08 00:53:33', '2026-06-22 14:53:51', NULL, 1),
(2, 1, 'Это второй пост для теста', NULL, NULL, 'Заполните, если это чисто текстовый пост, либо как дополнение к ссылке. 333', 2, 14375.9, 0, 0, 2, '2026-06-08 01:14:37', '2026-06-22 14:53:51', NULL, 0);
...
(1, 'php', 0, 'php', 'Язык1 программирования PHP и фреймворки', 1, '2026-06-08 04:08:44', NULL, 1),
(2, 'безопасность', 0, 'security', 'Уязвимости, безопасность и CSP политики', 1, '2026-06-08 04:08:44', NULL, 2),
(3, 'личное', 0, 'show', 'Демонстрация личных проектов разработчиков', 1, '2026-06-08 04:08:44', NULL, 3),
(4, 'видео', 0, 'video', 'Материал содержит видеоролик', 1, '2026-06-08 04:08:44', NULL, 3),
(5, 'libarea', 0, 'libarea', 'Обсуждение сайта...', 1, '2026-06-08 04:46:26', NULL, 4);
...
(1, 'Admin', 'admin@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', '2026-06-07 17:28:55', '2026-06-16 13:15:11', NULL, 1),
(2, 'test', 'test@test.ru', '$2y$10$xKEu8vvztJ/yoA2yaHHque9z4el8tdWKZDI4SY/AvX3HyyojdHFva', 'user', '2026-06-13 03:31:51', '2026-06-16 13:15:14', NULL, 1);
...
(1, 'О себе я расскажуыва ыва ыва 3', 'a6fa1e10b80411629030d4079a5d2253.jpg', '2026-06-16 13:15:11'),
(2, 'sdfsdfsdf', NULL, '2026-06-16 13:15:14');
...
(1, 1, 1, 1, 1, 1, '2026-06-16 13:15:11'),
(2, 1, 1, 1, 1, 1, '2026-06-16 13:15:14');
...
(5, 1, 'comment', 6, 1, '2026-06-08 02:28:01'),
(6, 1, 'story', 2, 1, '2026-06-08 02:28:05');
