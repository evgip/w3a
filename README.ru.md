...
Современный, легковесный новостной агрегатор, созданный на PHP 8.1+ и MySQL, вдохновлённый Hacker News. Модульная HMVC-архитектура, обновления в реальном времени и комплексные инструменты модерации.
